...
var Application = {
    initApplication: function () {
        $(window).load('pageinit', '#page-login', function () {
            ...
            $('#cart-user').on('click', function () {
                Application.initShowCartMenu();
            }),
            $('#profile-user').on('click', function () {
                Application.initShowProfile(localStorage.id);
            }),
            $('#promo-user2').on('click', function () {
                Application.initShowPromoUser();
            }),
            $('#cart-user2').on('click', function () {
                Application.initShowCartMenu();
            }),
            $('#profile-user2').on('click', function () {
                Application.initShowProfile(localStorage.id);
            }),
            $('#promo-user3').on('click', function () {
                Application.initShowPromoUser();
            }),
            $('#cart-user3').on('click', function () {
                Application.initShowCartMenu();
            }),
            $('#profile-user3').on('click', function () {
                Application.initShowProfile(localStorage.id);
            }),
            $('#promo-user4').on('click', function () {
                Application.initShowPromoUser();
            }),
            $('#cart-user4').on('click', function () {
                Application.initShowCartMenu();
            }),
            $('#profile-user4').on('click', function () {
                Application.initShowProfile(localStorage.id);
            }),
            ...
            $('#meja2').on('click', function () {
                Application.initShowMeja();
            }),
            $('#meja3').on('click', function () {
                Application.initShowMeja();
            }),
            ...
            $('#nav-pembayaran2').on('click', function () {
                Application.initPesananUser();
            }),
            $('#nav-pembayaran3').on('click', function () {
                Application.initPesananUser();
            }),
            ...
            $('#nav-riwayat2').on('click', function () {
                Application.initRiwayat();
            }),
            $('#nav-riwayat3').on('click', function () {
                Application.initRiwayat();
            }),
